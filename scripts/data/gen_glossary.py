...
TERMS: dict[str, dict[str, str]] = {
    ...
    "refrigerant-cycle-core": {
        "name": "Refrigerant-cycle core",
        "def": "Shared first-principles cycle calculation: refrigerant state "
        "points, compressor work, heat exchangers, cycle closure, COP, "
        "and diagnostics. Model families swap source and sink boundaries "
        "around this core.",
        "link": "concepts/cycle-architecture.html#the-shared-core",
    },
    "source-side": {
        "name": "Source side",
        "def": "Environmental side coupled to the evaporator in heating mode "
        "and to the condenser in cooling mode. Released TMHP source "
        "media include air and ground for DHW and space conditioning, "
        "and water for the WSHPB DHW family.",
        "link": "models/index.html",
    },
    "sink-side": {
        "name": "Sink side",
        "def": "Demand side receiving useful heat in heating mode or rejecting "
        "heat in cooling mode. TMHP demand-side examples include DHW "
        "tank charge and building loads.",
        "link": "models/index.html",
    },
    "environmental-medium": {
        "name": "Environmental medium",
        "def": "The outside thermal reservoir represented by a model family: "
        "outdoor air, a prescribed water loop, or a ground-loop/borehole "
        "field.",
        "link": "models/index.html",
    },
    "demand-side": {
        "name": "Demand side",
        "def": "The application boundary served by the heat pump. Released "
        "public boundaries are DHW tank charge for ASHPB/GSHPB/WSHPB "
        "and building heating/cooling load for ASHP/GSHP.",
        "link": "models/index.html",
    },
    "ashpb": {
        "name": "ASHPB (air-source heat pump boiler)",
        "def": "Air-source + DHW-tank instantiation of the shared TMHP "
        "refrigerant-cycle core. This is the validated reference example.",
        "link": "models/ashpb.html",
    },
    "gshpb": {
        "name": "GSHPB (ground-source heat pump boiler)",
        "def": "Ground-source + DHW-tank instantiation of the shared TMHP "
        "refrigerant-cycle core. Source side: borehole field via g-function.",
        "link": "models/gshpb.html",
    },
    "wshpb": {
        "name": "WSHPB (water-source heat pump boiler)",
        "def": "Water-source + DHW-tank instantiation of the shared TMHP "
        "refrigerant-cycle core. Source side: prescribed water inlet temperature.",
        "link": "models/wshpb.html",
    },
    "ashp": {
        "name": "ASHP (air-source heat pump, space conditioning)",
        "def": "Air-source heat pump driving a building load. "
        "It uses Q_r_iu > 0 for cooling and Q_r_iu < 0 for heating.",
    ...
    "gshp": {
        ...
        "It uses Q_r_iu > 0 for cooling and Q_r_iu < 0 for heating, "
        "with a borehole-field source and "
        "a building demand-side boundary.",
    ...
    "eta-vol": {
        ...
        "def": "Fraction of compressor displacement volume actually filled with refrigerant on each stroke.",
        "link": "models/ashpb.html",
    },
    "eta-mech": {
        "name": "η_mech (mechanical efficiency)",
        "def": "Shaft-to-compression work ratio. Captures bearing and transmission losses.",
        "link": "models/ashpb.html",
    },
}
